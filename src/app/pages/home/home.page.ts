...
import { Events, LoadingController, AlertController, ModalController, MenuController } from '@ionic/angular';
...
export class HomePage implements OnInit {
  ...
  constructor(public axservice: AxService, public events: Events, public paramService: ParameterService, private menuCtrl: MenuController,
    ...
    this.events.subscribe('loggedin', () => {
      paramService.authenticated = true;
  ...
  GetERPConfig() {
    this.axservice.GetERPConfig().subscribe(res => {
      this.storageServ.setERPConfig(res);
      this.paramService.erpConfig = res;
      console.log(res);
    })
  }
